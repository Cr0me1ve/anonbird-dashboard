...
`main` is built from the main branch. Release tags use the corresponding fork release version.
...
```shell
docker run -d --rm -p 80:80 ghcr.io/cr0me1ve/anonbird-dashboard:main
```
