...
export default function PeerActionCell() {
  ...
  const disableDashboardSSH = async () => {
    const choice = await confirm({
      ...
      description: (
        <div>
          Starting from AnonBird v0.61.0, once SSH access is disabled, you
          cannot re-enable it again from the dashboard. You&apos;ll need to
          create an explicit access control policy and update your AnonBird
          client to restore SSH functionality.{" "}
          <InlineLink
