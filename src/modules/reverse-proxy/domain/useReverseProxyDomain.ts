...
// to avoid e.g. "anonbird.cloud" matching when the actual domain is "eu.proxy.anonbird.cloud".
function parseDomain(
  ...
  const knownDomains = ["anonbird.cloud", "anonbird.app"];
