...
export const OnboardingIntent = ({ onSelect, useCases, isBusiness }: Props) => {
  ...
  return (
    <div className={"relative flex flex-col h-full justify-between"}>
      <div>
        <h1 className={"text-xl text-center"}>Get started with AnonBird</h1>
        <div
          className={
            "text-sm text-nb-gray-300 font-light mt-2 block text-center sm:px-4"
          }
        >
          AnonBird provides the flexibility of both an anonymous overlay network
          and remote network access. Choose what fits your needs, you can always
          combine both.
        </div>
        <div
          className={cn(
        ...
        >
          <IntentCard
            ...
            description={
              isBusiness
                ? "Install AnonBird on two or more devices to create anonymous mesh connections, like laptop to server or server to database. Add at least two machines to get started."
                : "Install AnonBird on two or more devices in your homelab, such as your laptop, NAS, or Raspberry Pi, to create anonymous mesh connections."
            }
          ...
          <IntentCard
            ...
            description={
              isBusiness
                ? "Enable employee remote access to VMs, Kubernetes clusters, and cloud or on-prem resources without installing AnonBird on every machine."
                : "Securely access your homelab remotely from anywhere without installing AnonBird on every device."
            }
