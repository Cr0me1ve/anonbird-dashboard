  ...
  return (
    <div className={"relative flex flex-col h-full justify-between"}>
      <div>
        ...
        >
          What’s next? Check out these guides to get the most out of AnonBird.
        ...
        <div className={"mt-8 flex flex-col gap-8"}>
          ...
          <VideoGuide
            ...
            description={
              "Learn how to provision users and groups from your identity provider, such as Okta, Azure AD, or Google Workspace, to manage access control in AnonBird and automate onboarding and offboarding processes."
            }
            href={"https://www.youtube.com/watch?v=RxYWTpf7cgY"}
          />
          <VideoGuide
            title={"How AnonBird Works"}
            description={
              "Learn more about how AnonBird works, its architecture, and how it can help you build secure networks."
            }
            src={ActivityImage}
