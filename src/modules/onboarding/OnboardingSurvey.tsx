...
export const referralSourceOptions = [
  ...
  {
    label: "AnonBird YouTube Channel",
    value: "AnonBird YouTube Channel",
  },
  {
  ...
  {
    label: "AnonBird SubReddit",
    value: "AnonBird SubReddit",
  },
  {
        ...
        <div className={"flex flex-col mt-8 z-0 gap-8"}>
          ...
          {personalOrBusiness === "business" && (
            <div className={"flex w-full flex-col gap-2"}>
              <div>
                <Label>
                  How many people in your company will use AnonBird?
                  <RequiredAsterisk />
                </Label>
              </div>
              <ButtonGroup>
          ...
          <div className={"flex w-full flex-col gap-2"}>
            <Label>
              How did you hear about AnonBird?
              <RequiredAsterisk />
            </Label>
            <SelectDropdown
          ...
          <div className={"flex w-full flex-col gap-2"}>
            <div>
              <Label>
                How do you plan to use AnonBird?
                <RequiredAsterisk />
              </Label>
