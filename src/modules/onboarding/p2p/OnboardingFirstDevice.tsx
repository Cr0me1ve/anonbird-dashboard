  ...
  return (
    <div className={"relative flex flex-col h-full gap-4"}>
      <div>
        ...
        >
          {`To access other machines, install AnonBird, sign in, and your device joins the network.
          Every device you add becomes an AnonBird peer in your network. It's that simple.`}
        </div>
      </div>
