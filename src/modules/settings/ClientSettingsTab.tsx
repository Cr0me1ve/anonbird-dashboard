      ...
      <div className={"p-default py-6 max-w-2xl"}>
        ...
        <div className={"flex flex-col gap-10 w-full mt-8"}>
          <div className={"flex flex-col relative"}>
            ...
            <HelpText>
              Configure how AnonBird clients receive update notifications. When
            ...
            {autoUpdateAlways && autoUpdateMethod !== "disabled" && (
              ...
              >
                Enabling automatic updates will restart the AnonBird client
          ...
          <div>
            <div>
              ...
              <HelpText>
                Allow peers to expose local services through the AnonBird
                reverse proxy using the CLI. <br /> This requires at least
                AnonBird{" "}
            ...
            <FancyToggleSwitch
              ...
              helpText={
                <>
                  ...
                  required. This requires AnonBird client v0.45 or higher.
